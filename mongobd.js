...
//Подключаемся к БД
mongoose
    .connect(process.env.URL_BD_CONNECT, {
...
const mediaSchema = new mongoose.Schema({ fileName: String, fileId: String, data: Buffer }, { versionKey: false });

//Создаем модели юзеров, чатов и настроек
